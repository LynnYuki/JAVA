...
<%
	...
	Person[] persons = {
		new Person("Liu", "12345678", 34, dateFormat.parse("1982-01-01")), 
		new Person("Kitty", "12345678", 23, dateFormat.parse("1984-02-25")),
		new Person("Sanddy", "12345678", 23, dateFormat.parse("1994-09-12")),
	};
